        ...
        <article className="blog-post-content">
          ...
          <figure className="coop-icons">
            <input
              ...
              className="coop-icon"
              id="coop-1"
              onClick={this.toggleCoopOne}
              onMouseEnter={this.handleCoopOneHover.bind(this)}
              onMouseLeave={this.handleLeaveCoopOneHover.bind(this)}
            />
            <input
              type="image"
              src={waveIcon}
              ...
              className="coop-icon"
              id="coop-2"
              onClick={this.toggleCoopTwo}
              onMouseEnter={this.handleCoopTwoHover.bind(this)}
              onMouseLeave={this.handleLeaveCoopTwoHover.bind(this)}
            />
            <input
              type="image"
              src={waveIcon}
              ...
              className="coop-icon"
              id="coop-3"
              onClick={this.toggleCoopThree}
              onMouseEnter={this.handleCoopThreeHover.bind(this)}
              onMouseLeave={this.handleLeaveCoopThreeHover.bind(this)}
            />
          </figure>
          <Collapse isOpen={this.state.coopOneIsOpen}>
            <Card className="coop--card">
              <CardBody className="coop--card-body">
                My first coop placement was at Design Plastics International
                (DPI) from May-Aug of 2018. DPI is a small company which
                designs, prototypes, and builds displays for stores and
          ...
          <Collapse isOpen={this.state.coopTwoIsOpen}>
            <Card className="coop--card">
              <CardBody className="coop--card-body">
                ...
                Wave is a start up in Leslieville, Toronto that provides
                financial solutions for small businesses. This coop, I was on
                the Machine Learning Team, and Learned a lot about working with
                Machine Learning models, and how to leverage them in data
                analysis. Be sure to check out more details on my{" "}
          ...
          <Collapse isOpen={this.state.coopThreeIsOpen}>
            <Card className="coop--card">
              <CardBody className="coop--card-body">
                My third coop placement was also at Wave HQ, but, from Sept-Dec
                of 2019. Wave is a start up in Leslieville, Toronto that
          ...
          <UncontrolledPopover
            isOpen={this.state.hoverCoopOne}
            placement="bottom"
            target="coop-1"
          >
            <PopoverHeader>Design Plastics International</PopoverHeader>
            <PopoverBody>
              My first coop was at Design Plastics Internation from May-Aug of
              2018. Click the logo to learn more.
            </PopoverBody>
          </UncontrolledPopover>
          <UncontrolledPopover
            isOpen={this.state.hoverCoopTwo}
            placement="bottom"
            target="coop-2"
          >
            <PopoverHeader>Wave HQ - Machine Learning</PopoverHeader>
            <PopoverBody>
              My second coop was at Wave HQ from Jan-Apr of 2019. Click the logo
              to learn more.
            </PopoverBody>
          </UncontrolledPopover>
          <UncontrolledPopover
            isOpen={this.state.hoverCoopThree}
            placement="bottom"
            target="coop-3"
          >
            <PopoverHeader>Wave HQ - Accounting Platform</PopoverHeader>
            <PopoverBody>
              My third coop was at Wave HQ from Sept-Dec of 2019. Click the logo
              to learn more.
            </PopoverBody>
          </UncontrolledPopover>
          <p>
            {" "}
            I enjoy travelling the world with my friends & family and
            discovering new adventures along the way. I also have a passion for
            Jeeps, especially Wranglers! I am always looking for new
            opportunities to learn and grow my skills as a young engineer.{" "}
          </p>
          ...
          <br />
          Like what you see? Check out my <Link to="/About">about page</Link> or <Link to="/Resume">Resume.</Link>
        </article>
      </Layout>
    )
  }
