...
export default () => (
  <Layout>
    ...
    <article className="blog-post-content">
      <p>
        I've always loved exploring how things work and being creative along the way. 
        ...
        To learn more about my academics and interests, feel free to check out one of my <Link to="/Blog">Blog Posts</Link>, or my <Link to="/Resume">Resume</Link>!
        </p>
        <h2>There's more than just my acedemics!</h2>
        <p>
          Although I do have a fondness for academia, it is definitely not how I define myself. 
          Outside of school I enjoy tinkering on my own projects, learning new creative disciplines, and playing with my Jeep!
          My current project happens to be this website. `#TODO: update when I take on my next project ;)`
          Currently, I'm really enjoying working on this site, and trying to make it as official as I can.
          One creative discipline which I most recently attempted to master is the art of embroidery.
